<template>
  <header ref="headerEl" class="relative">
    <div
      class="fixed w-full transition-[padding] duration-300 ease-in-out z-40"
      :class="{
        'before:bg-white before:absolute before:top-0 before:left-0 before:h-full before:w-full before:-z-10':
          !isScroll,
        'py-5 lg:py-8': isScroll,
        'py-3 lg:py-3.5': !isScroll
      }"
    >
